...
public class TouchscreenControllerView extends FrameLayout {
    ...
    public void updateOrientation() {
        ...
        // x translation for dpad
        if (mDPadView != null) {
            mDPadView.setTranslationX(dpToPixels(100)); // move right 20dp
        }
    }
    ...
    public void init(int controllerIndex, String controllerType, String viewType, boolean hapticFeedback, boolean gliding) {
        ...
        linkButton(mMainView, R.id.controller_button_l2, "L2Button", "L2", false, gliding);
        ...
        linkButton(mMainView, R.id.controller_button_r2, "R2Button", "R2", false, gliding);
        ...
        linkHotkeyButton(mMainView, R.id.controller_button_pause, "OpenPauseMenu",
                TouchscreenControllerButtonView.Hotkey.OPEN_PAUSE_MENU, false);
